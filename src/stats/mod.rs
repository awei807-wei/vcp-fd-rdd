...
pub struct WatchStateReport {
    ...
    pub logical_watch_cost: u64,
    pub kernel_watch_cost: u64,
    pub skipped_watch_cost: u64,
    ...
    pub ephemeral_watch_created: u64,
    ...
    pub rotating_cold_window_cycle_progress_pct: u8,
    pub rotating_cold_window_promoted_to_ephemeral: u64,
    pub rotating_cold_window_fast_scan_lease_dirs: u64,
    pub rotating_cold_window_scan_only_dirs: u64,
    pub rotating_cold_window_ephemeral_selected_dirs: u64,
    pub rotating_cold_window_fast_scan_lease_selected_dirs: u64,
    pub rotating_cold_window_scan_only_selected_dirs: u64,
    pub rotating_cold_window_ephemeral_estimated_cost: u64,
    pub rotating_cold_window_fast_scan_lease_estimated_cost: u64,
    pub rotating_cold_window_scan_only_estimated_cost: u64,
    pub rotating_cold_window_last_tick_ephemeral_dirs: u64,
    pub rotating_cold_window_last_tick_ephemeral_estimated_cost: u64,
    pub rotating_cold_window_last_tick_fast_scan_lease_dirs: u64,
    pub rotating_cold_window_last_tick_fast_scan_lease_estimated_cost: u64,
    pub rotating_cold_window_last_tick_scan_only_dirs: u64,
    pub rotating_cold_window_last_tick_scan_only_estimated_cost: u64,
    pub rotating_cold_window_adjacent_cycle_reselected_dirs: u64,
    pub rotating_cold_window_adjacent_cycle_action_switches: u64,
    pub rotating_cold_window_last_tick_adjacent_cycle_reselected_dirs: u64,
    pub rotating_cold_window_last_tick_adjacent_cycle_action_switches: u64,
    pub rotating_cold_window_budget_blocked: u64,
    pub cold_freshness_age_p50_secs: u64,
    pub cold_freshness_age_p95_secs: u64,
    pub cold_freshness_age_p99_secs: u64,
    ...
    pub fast_scan_mode: String,
    pub fast_scan_sla_ok: bool,
    pub fast_scan_local_strict_ok: bool,
    pub fast_scan_target_secs: u64,
    pub fast_scan_tick_ms: u64,
    ...
    pub fast_scan_pending_changed_dirs: usize,
    pub fast_scan_checked_dirs: u64,
    pub fast_scan_changed_dirs: u64,
    pub fast_scan_generated_events: u64,
    pub fast_scan_coverage_lag_p50_ms: u64,
    pub fast_scan_coverage_lag_p95_ms: u64,
    pub fast_scan_coverage_lag_p99_ms: u64,
    pub fast_scan_budget_degraded: bool,
    pub fast_scan_last_overdue_dir: String,
    pub fast_scan_last_degraded_reason: String,
    pub fast_scan_parent_fence_retries: u64,
    pub fast_scan_epoch_conflicts: u64,
