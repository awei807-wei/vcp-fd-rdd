...
impl From<&HealthTelemetry> for MetricsHealthSnapshot {
    fn from(h: &HealthTelemetry) -> Self {
        Self {
            ...
            inotify_dirty_dirs_enqueued: h.inotify_dirty_dirs_enqueued,
            inotify_dirty_dirs_suppressed: h.inotify_dirty_dirs_suppressed,
            ...
            waterline_soft_degraded: h.waterline_soft_degraded,
            waterline_hard_degraded: h.waterline_hard_degraded,
            waterline_effective_l3_scan_interval_secs: h.waterline_effective_l3_scan_interval_secs,
            waterline_effective_rotating_budget: h.waterline_effective_rotating_budget,
...
impl MetricsRuntimeSnapshot {
    pub fn from_reports(stats: StatsReport, pipeline: EventPipelineStats) -> Self {
        Self {
            ...
            query_guard_hold_total_ns: stats.query_guard_hold_total_ns,
            query_guard_hold_p50_us: stats.query_guard_hold_p50_us,
            query_guard_hold_p95_us: stats.query_guard_hold_p95_us,
            query_guard_hold_p99_us: stats.query_guard_hold_p99_us,
