...
impl TieredIndex {
    ...
    pub(super) fn new_with_base_and_io_governor(
        ...
        Self {
            ...
            follow_symlinks,
            exclude_dirs,
            fs_policy_config: fs_policy_config.clone(),
            fs_policy_config_shared: Mutex::new(Arc::new(fs_policy_config)),
            ...
            recovery_quarantine: super::quarantine::RecoveryQuarantine::default(),
            ...
            io_tuning: super::IoTuning::default(),
            mount_policy_counters,
            io_governor,
            stats: Arc::new(crate::stats::StatsCollector::new()),
            content: super::content::ContentIndexState::default(),
