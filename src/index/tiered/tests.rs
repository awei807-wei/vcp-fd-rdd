...
// startup_reconcile_recovers_offline_add_and_delete and
// compaction_prefix_replaces_base_and_keeps_suffix_deltas were removed in the Phase 1
// refactor: startup_reconcile / compact_layers / maybe_spawn_compaction were deleted.
// See 重构方案包/causal-chain-report.md §8.4 (REMOVE list) and §8.6 phase 1.
