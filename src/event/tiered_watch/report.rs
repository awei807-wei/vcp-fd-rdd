...
impl TieredWatchRuntime {
    ...
    pub fn report(&self) -> WatchStateReport {
        ...
        // ── Cold freshness ages (p50/p95/p99) for L2/L3 directories ─────────
        let cold_freshness_ages = {
            let dirs = self.dirs.read();
        ...
        self.check_waterline_alarm(fs.fast_scan_coverage_lag_p99_ms);
