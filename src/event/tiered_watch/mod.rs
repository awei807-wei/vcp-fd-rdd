...
pub(super) struct RotatingColdWindowProgress {
    ...
    pub(super) last_selected_action: Option<RotatingColdWindowActionKind>,
}
...
pub struct TieredWatchRuntime {
    ...
    rotating_cold_window_ephemeral_selected_dirs: AtomicU64,
    rotating_cold_window_fast_scan_lease_selected_dirs: AtomicU64,
    rotating_cold_window_scan_only_selected_dirs: AtomicU64,
    rotating_cold_window_ephemeral_estimated_cost: AtomicU64,
    rotating_cold_window_fast_scan_lease_estimated_cost: AtomicU64,
    rotating_cold_window_scan_only_estimated_cost: AtomicU64,
    rotating_cold_window_adjacent_cycle_reselected_dirs: AtomicU64,
    rotating_cold_window_adjacent_cycle_action_switches: AtomicU64,
    rotating_cold_window_last_tick_telemetry: RwLock<RotatingColdWindowTickTelemetry>,
...
impl TieredWatchRuntime {
    ...
    pub fn new_with_l0_max_cost_and_ephemeral(
        ...
        Self {
            ...
            rotating_cold_window_ephemeral_selected_dirs: AtomicU64::new(0),
            rotating_cold_window_fast_scan_lease_selected_dirs: AtomicU64::new(0),
            rotating_cold_window_scan_only_selected_dirs: AtomicU64::new(0),
            rotating_cold_window_ephemeral_estimated_cost: AtomicU64::new(0),
            rotating_cold_window_fast_scan_lease_estimated_cost: AtomicU64::new(0),
            rotating_cold_window_scan_only_estimated_cost: AtomicU64::new(0),
            rotating_cold_window_adjacent_cycle_reselected_dirs: AtomicU64::new(0),
            rotating_cold_window_adjacent_cycle_action_switches: AtomicU64::new(0),
            rotating_cold_window_last_tick_telemetry: RwLock::new(
                RotatingColdWindowTickTelemetry::default(),
            ),
